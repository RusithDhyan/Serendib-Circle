  ...
  return (
    <div className="card">
      ...
      <div className="mb-6">
        ...
        <div className="text-2xl font-bold text-serendib-primary mb-1">{user.tier}</div>
      ...
      {nextTier ? (
        <>
          <div className="mb-4">
            ...
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div className="bg-gradient-to-r from-serendib-secondary to-serendib-accent h-3 rounded-full transition-all duration-500" style={{ width: `${progress}%` }} />
            </div>
          </div>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <div className="font-semibold">{user.totalStays} / {nextTier.stays}</div>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <div className="font-semibold">${user.totalSpend} / ${nextTier.spend}</div>
              </div>
              <ChevronRight className="text-gray-400" size={20} />
            </div>
            ...
            <div className="text-sm text-gray-600">
              {nextTier.name === 'Adventurer' && '25% point bonus + Early check-in'}
              {nextTier.name === 'Voyager' && '50% point bonus + Room upgrades'}
              {nextTier.name === 'The Circle' && '100% point bonus + VIP status'}
            </div>
          </div>
          </div>
        </>
        ...
        <div className="p-4 bg-serendib-gold/10 rounded-lg text-center">
          <div className="text-lg font-bold text-serendib-gold mb-2">🎉 Highest Tier Achieved!</div>
