  ...
  const vouchers = [
    {
      ...
      amount: 1000,
      content: "Redeem with 10000 points",
    },
    {
      type: "room",
      icon: Bed,
      ...
      amount: 5000,
      content: "Redeem with 50000 points",
    },
    {
      type: "experience",
      icon: Sparkles,
      ...
      amount: 15000,
      content: "Redeem with 150000 points",
    },
  ];
          ...
          >
            ...
            {selectedVoucher === voucher.type ? (
              <div className="space-y-2">
                <div className="flex justify-end items-center text-sm font-semibold text-purple-700 mb-2 bg-purple-100 p-2 rounded-xl shadow-md">
                  {voucher.content}
                </div>
