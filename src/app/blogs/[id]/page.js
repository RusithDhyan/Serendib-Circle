"use client";
import AddBlogContent from "@/app/(components)/(blog)/(forms)/AddBlogContent";
import BlogContent from "@/app/(components)/(blog)/BlogContent";
import Sidebar from "@/app/(components)/Sidebar";
import { useData } from "@/app/context/DataContext";
import { BadgePlus, CircleChevronLeft, CircleChevronRight } from "lucide-react";
    ...
    <div className="flex px-3">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 bg-white  rounded-lg shadow-md pt-5">
          ...
          {currentUser?.permissions?.canCreateBlogContent && (
