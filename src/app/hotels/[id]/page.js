...
import OfferSlider from "@/app/(components)/(hotels)/Offers";
...
import AddAccommodation from "@/app/(components)/(hotels)/(forms)/AddAccommodation";
import AddPageExperience from "@/app/(components)/(hotels)/(forms)/AddPageExperience";
import AddGallery from "@/app/(components)/(hotels)/(forms)/AddGallery";
import AddOffer from "@/app/(components)/(hotels)/(forms)/AddOffer";
import AddService from "@/app/(components)/(hotels)/(forms)/AddService";
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 bg-white  rounded-lg shadow-md pt-5">
          ...
          <div className="space-y-2 p-4 2xl:w-350">
            <h2 className="sm:text-lg 2xl:text-xl font-bold">Card Title  : <span className="text-gray-700 sm:text-sm 2xl:text-lg">{hotel?.title}</span></h2>
            <p className="sm:text-lg 2xl:text-xl font-bold">Location : <span className="text-gray-700 sm:text-sm 2xl:text-lg">{hotel?.location}</span></p>
            <p className="sm:text-lg 2xl:text-xl font-bold">Card Description : <span className="text-gray-700 text-sm">{hotel?.description}</span></p>
          </div>
        ...
        <div className="flex items-center justify-between px-3 mt-10  border-b sm:w-68 2xl:w-80">
          <h1 className="sm:text-xl 2xl:text-2xl font-bold">Add Accommodation</h1>
          <button
        ...
        <div className="flex items-center justify-between px-3 mt-10  border-b sm:w-66 2xl:w-80">
          <h1 className="sm:text-xl 2xl:text-2xl font-bold">Add Page-Experience</h1>
          <button
