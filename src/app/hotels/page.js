      ...
      >
        ...
        <div className="flex items-center justify-between px-2 py-2 border-b border-gray-300 mx-4 mt-5">
          ...
          <div className="flex items-center gap-4">
            ...
            {currentUser?.permissions?.canCreateHotel && (
            <button
        ...
        {/* {!currentUser?.permissions?.canReadHotel ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-6 sm:mt-5 2xl:mt-10 pb-5">
          {hotels.map((hotel) => (
            <div key={hotel._id} className="bg-white rounded-md shadow-md overflow-hidden hover:shadow-lg transition duration-300">
              ...
              <div className="p-4 flex flex-col 2xl:gap-2">
                ...
                <div className="flex gap-3 mt-2">
                  {currentUser?.permissions?.canUpdateHotel && (
                  <button
                    onClick={() => {
                  ...
                  {currentUser?.permissions?.canDeleteHotel && (
                  <button
