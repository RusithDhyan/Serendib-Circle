...
export default function OurCollection() {
  ...
  return (
    <div className="flex-1 overflow-hidden mt-12 ml-64">
      <div>
        <Breadcrumbs />
        ...
        {!session?.user?.permissions?.canReadHotel ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-6 sm:mt-5 2xl:mt-10 pb-5">
            {hotels.map((hotel) => (
              <div
                key={hotel._id}
                className="bg-white rounded-md shadow-sm  hover:shadow-lg transition duration-300"
              >
                <div className="w-full sm:h-50 2xl:h-60 relative z-0 overflow-hidden">
