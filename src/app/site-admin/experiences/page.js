    ...
    <div className="flex-1 mt-12 ml-64">
      ...
      <div className="flex-1 transition-all duration-300 ml-1">
        ...
        <div className="flex items-center justify-between px-2 py-2 my-5 border-b border-gray-300 mx-4">
          <h1 className="sm:text-xl 2xl:text-2xl font-bold">All Experiences</h1>
          {session?.user?.permissions?.canCreateExperience && (
            <button
                ...
                currentExperience.map((experience) => (
                  ...
                  >
                    <td className="px-4 py-1">
                      <Link href={`/site-admin/experiences/${experience._id}`}>
                        <Image
                    ...
                    <td className="px-4 py-2">
                      <Link
                        ...
                        href={`/site-admin/experiences/${experience._id}`}
                      >
                        {experience.title}
                      </Link>
                    </td>

                    <td className="px-4 py-1 text-serendib-accent font-bold">
                      {experience.type}
                    </td>
                    ...
                    <td className="px-4 py-1 border-b border-gray-300 hover:bg-orange-50">
                      <div className="flex gap-2">
                        {session?.user?.permissions?.canUpdateExperience && (
                          <button
                            onClick={() => {
                        ...
                        {session?.user?.permissions?.canDeleteExperience && (
                          <button
