"use client";
import AddExpContent from "@/app/site-admin/(components)/(experience)/AddExpContent";
import ExpContent from "@/app/site-admin/(components)/(experience)/ExpContent";
import { getExperience } from "@/lib/fetchData";
            ...
            <div className="bg-white rounded-md shadow-md overflow-hidden hover:shadow-lg transition duration-300">
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                {experience?.bulletPoints?.length > 0 && (
                  <>
                    <h1 className="text-xl mt-2 underline">
                      Experience Packages
                    </h1>
