  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Track and manage all voucher redemptions</p>
      </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Voucher Code</th>
              ...
              <tbody>
                {redemptions.map((redemption) => {
                  ...
                  return (
                    <tr key={redemption._id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-semibold capitalize">{redemption.type}</span>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                      ...
                      <td className="py-4 px-6">
                        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full ${statusColor}`}>
                          <StatusIcon size={16} />
                          <span className="text-sm font-semibold capitalize">{redemption.status}</span>
                        </div>
                      </td>
                      <td className="py-4 px-6">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="space-y-3">
              {['dining', 'room', 'experience'].map(type => {
                ...
                const value = redemptions.filter(r => r.type === type).reduce((sum, r) => sum + r.dollarValue, 0);
                return (
          ...
          <div className="bg-gradient-to-br from-serendib-primary to-serendib-secondary text-white rounded-xl shadow-md p-6">
            ...
            <div className="space-y-4">
              <div>
                <div className="text-sm opacity-90 mb-1">Total Points Redeemed</div>
                <div className="text-3xl font-bold">{stats.totalPoints.toLocaleString()}</div>
              </div>
              <div>
                <div className="text-sm opacity-90 mb-1">Total Dollar Value</div>
                <div className="text-3xl font-bold">${stats.totalValue.toLocaleString()}</div>
              </div>
              <div>
                <div className="text-sm opacity-90 mb-1">Average Redemption</div>
