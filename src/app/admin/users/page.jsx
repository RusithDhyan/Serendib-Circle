...
export default function AdminUsers() {
  ...
  const getTierColor = (tier) => {
    switch (tier) {
      case 'The Circle': return 'bg-yellow-100 text-yellow-800';
      case 'Voyager': return 'bg-blue-100 text-blue-800';
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Spend</th>
                  <th className="text-left py-4 px-6 font-semibold text-gray-700">Stays</th>
