...
import AddHomeContent from "../(components)/(hotels)/(forms)/AddHomeContent";
...
export default function HomeContent() {
  ...
  const { homeSlider, currentUser } = useData();
  ...
  return (
    <ProtectedRoute>
      <div className="flex">
        <div
          className={`
          bg-gray-100 shadow-md transition-all duration-200
        ...
        >
          ...
          {currentUser?.permissions?.canCreateHomeSlider && (
          ...
          <div className="space-x-2 flex items-center justify-end px-3 gap-2">
            ...
            {currentUser?.permissions?.canDeleteHomeSlider && (
              <button
          ...
          {currentUser?.permissions?.canCreateHomeTop && (
          ...
          <div>
            {currentUser?.permissions?.canCreateHomeMiddle && (
          ...
          <div>
            {currentUser?.permissions?.canCreateHomeExp && (
          ...
          <div>
            {currentUser?.permissions?.canCreateHomeBottom && (
